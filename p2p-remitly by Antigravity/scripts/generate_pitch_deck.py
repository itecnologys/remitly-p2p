...
def create_pitch_deck():
    ...
    # Paths to generated images (Apple Style)
    IMG_DIR = r'C:\Users\mini\.gemini\antigravity\brain\ed3698f6-d8bb-454d-ab0f-bd67d055d573'
    IMG_COVER = os.path.join(IMG_DIR, 'fluxus_pitch_cover_apple_style_1776265575631.png')
    IMG_NETWORK = os.path.join(IMG_DIR, 'fluxus_global_network_apple_style_1776265600098.png')
    IMG_UI = os.path.join(IMG_DIR, 'fluxus_cockpit_ui_apple_style_1776265623017.png')
    IMG_ATOMIC = os.path.join(IMG_DIR, 'fluxus_atomic_settlement_apple_style_1776265642427.png')
    ...
    # Final Save
    OUTPUT_FILE = r'c:\LAPTOP\remitly-p2p\p2p-remitly by Antigravity\FLUXUS_INSTITUTIONAL_PITCH_DECK.pptx'
    prs.save(OUTPUT_FILE)
    print(f"Pitch Deck salvo em: {OUTPUT_FILE}")
