...
- **Resultado:** O investidor provê BRL e lucra com o ágio (premium) do USDT no mercado local, além da sua fatia do **spread de remessa** (precificação **Dominância/Tiered** — `03_TECHNICAL/TECH_FLUXUS_PRICING_CANON.md`).
