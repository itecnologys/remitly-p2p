...
1. **Taxa de Serviço Low-Cost:** US$ 1.99 fixo (por corredor; **adicional** ao spread de câmbio quando o produto a empilhar).
2. **Spread de Câmbio P2P:** referência **Dominância/Tiered** (fonte: `TECH_FLUXUS_PRICING_CANON.md`). O LP no Brasil aceita trocar seu BRL por USD/USDT com ágio equilibrado dentro do envelope de pricing, resultando em taxa final melhor que a do mercado varejo opaco.
