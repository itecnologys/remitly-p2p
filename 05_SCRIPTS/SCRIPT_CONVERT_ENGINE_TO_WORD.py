...
if __name__ == "__main__":
    ...
    MD_FILE = repo_root / "01_BOOKS" / "BOOK_ENGINE_HANDBOOK.md"
    DOCX_FILE = repo_root / "01_BOOKS" / "BOOK_ENGINE_HANDBOOK_LATEST.docx"
    COVER_IMAGE = repo_root / "06_DATA" / "DATA_FLUXUS_COVER.png"

    convert_md_to_docx(str(MD_FILE), str(DOCX_FILE), str(COVER_IMAGE))
